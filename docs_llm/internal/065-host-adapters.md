...
- P14: `pages/ordini.py` or `pages/ordini/ordini.py`; both → error; companion = same name in page folder; JS pages in a separate folder; owner exception to §13; companion public, server-only logic in modules it does not import.
