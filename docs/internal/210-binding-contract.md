...
| src/gramlot/renderer/html_renderer.py (proposed) | GramlotHtmlRenderer(HtmlRenderer), string rendering | S03bis |
| src/gramlot/renderer/svg_renderer.py (proposed) | GramlotSvgRenderer(SvgRenderer) | S03bis |
